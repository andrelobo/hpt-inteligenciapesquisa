    ...
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        ...
        <div className="mt-6 flex flex-wrap justify-center gap-2">
          ...
          <a
            href="/"
            className="inline-flex items-center justify-center rounded-lg border border-border bg-surface px-5 py-2.5 text-sm font-medium text-foreground transition-colors hover:bg-accent"
          >
            Voltar ao início
          </a>
        </div>
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Sistema de Pesquisas HPT | Inteligência Pedagógica" },
      {
        name: "description",
        content:
      ...
      { property: "og:title", content: "Sistema de Pesquisas HPT | Inteligência Pedagógica" },
      {
        ...
        content:
          "Inteligência Pedagógica para Treinamentos Inclusivos — diagnóstico da turma antes do início do curso.",
      },
